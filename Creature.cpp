...
void Creature::incubate(int checkX, int checkY ,Grid board[][FIELDSIZE]) {//指定地点に生物がいる前提。孵化の内容を実行。
...
void Creature::damage(int checkX, int checkY, Grid board[][FIELDSIZE]) {//指定地点に生物がいる前提。攻撃の内容を実行。
