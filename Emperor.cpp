...
bool Emperor::specialMovement1(int size, PenguinKids* mobs_PenguinKids, Bull* mobs_Bull, Grid board[][FIELDSIZE], Character* handledCharacters) {//特殊技：産卵
	int checkX = 0;
	int checkY;
	int drctnX, drctnY;
...
bool Emperor::specialMovement2(int size, Grid board[][FIELDSIZE], Character* handledCharacters) {//特殊技：孵化
	int checkX = 0;
	int checkY;
	int drctnX, drctnY;
	GETdirectionXY(&drctnX, &drctnY);
