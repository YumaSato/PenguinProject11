...
bool Bull::walk(int size, Grid** board, Emperor* handledCharacters) {
	int ix;
	int iy;
	int dx;
	int dy;
...
bool Bull::specialMovement1(int size, PenguinKids* mobs_PenguinKids, Bull* mobs_Bull, Grid** board, Emperor* handledCharacters) {
	return TRUE;
}

bool Bull::specialMovement2(int size, Grid** board, Emperor* handledCharacters) {
	return TRUE;
}

bool Bull::attack(int size, Grid** board, Emperor* handledCharacters) {
	int ix;
	int iy;
	int dx;
	int dy;
