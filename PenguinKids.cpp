...
bool PenguinKids::attack(int size, Grid** board, Emperor* handledCharacters) {
...
bool PenguinKids::specialMovement1(int size, PenguinKids* mobs_PenguinKids, Bull* mobs_Bull, Grid** board, Emperor* handledCharacters) {//産卵
	if (status == NORMAL) {
		//exhibitScreen();
...
bool PenguinKids::specialMovement2(int size, Grid** board, Emperor* handledCharacters) {
